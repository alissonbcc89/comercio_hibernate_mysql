...
public class Pedido implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4257581882297843816L;
	...
	private Set<Produto> porduto = new HashSet<Produto>();
	...
	public Set<Produto> getPorduto() {
		return porduto;
	}

	public void setPorduto(Set<Produto> porduto) {
	...
	public int hashCode() {
		...
		result = prime * result + ((porduto == null) ? 0 : porduto.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (pedido == null) {
			...
			return false;
		if (porduto == null) {
			if (other.porduto != null)
				return false;
		} else if (!porduto.equals(other.porduto))
			return false;
		return true;
	}
